...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => SITE_DIR . "include/main_page_logo.php"
	)
);?>
<?$APPLICATION->IncludeComponent(
	"bitrix:main.include",
	...
	Array(
		...
		"AREA_FILE_SUFFIX" => "inc",
		"EDIT_TEMPLATE" => "",
		"PATH" => SITE_DIR . "include/main_page_info.php"
	)
);?>
<?$APPLICATION->IncludeComponent(
	"bitrix:news.list",
	...
	<div class="title title--gold">
		<?$APPLICATION->IncludeComponent(
			...
			Array(
				...
				"AREA_FILE_SUFFIX" => "inc",
				"EDIT_TEMPLATE" => "",
				"PATH" => SITE_DIR . "include/main_page_title_1.php"
			)
		);?>
	</div>
	<?$APPLICATION->IncludeComponent(
		...
		Array(
			...
			"AREA_FILE_SUFFIX" => "inc",
			"EDIT_TEMPLATE" => "",
			"PATH" => SITE_DIR . "include/main_page_text_1.php"
		)
	);?>
  </div>
	...
	<div class="player col-xl-10">
	  <?$APPLICATION->IncludeComponent(
			...
			Array(
				...
				"AREA_FILE_SUFFIX" => "inc",
				"EDIT_TEMPLATE" => "",
				"PATH" => SITE_DIR . "include/main_page_player.php"
			)
		);?>
	</div>
  </div>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SORT_ORDER2" => "ASC",
		"STRICT_SECTION_CHECK" => "N",
		"COMPONENT_TEMPLATE" => "main_page_contacts"
	),
	false
);?>
<?$APPLICATION->IncludeComponent(
	  ...
	  <div class="title title--gold">
	  	<?$APPLICATION->IncludeComponent(
			...
			Array(
				...
				"AREA_FILE_SUFFIX" => "inc",
				"EDIT_TEMPLATE" => "",
				"PATH" => SITE_DIR . "include/main_page_title_2.php"
			)
		);?>
	  </div>
	  <div class="text text--white">
	  	<?$APPLICATION->IncludeComponent(
			...
			Array(
				...
				"AREA_FILE_SUFFIX" => "inc",
				"EDIT_TEMPLATE" => "",
				"PATH" => SITE_DIR . "include/main_page_text_2.php"
			)
		);?>
	  </div>
	</div>
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PAGER_TEMPLATE" => ".default",
		"PAGER_TITLE" => "Галерея",
		"PROPERTY_CODE" => array(0=>"",1=>"IMAGES",2=>"",),
		"SET_BROWSER_TITLE" => "N",
		"SET_CANONICAL_URL" => "N",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "N",
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"AREA_FILE_SUFFIX" => "inc",
		"EDIT_TEMPLATE" => "",
		"PATH" => SITE_DIR . "ajax/callback.php"
	)
);?>
</div>
<?
